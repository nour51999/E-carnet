...
<div class="c ">
    ...
    <form action="{{ route('note.search') }}" method="GET" class="formr flex">
    ...
    <form method="POST" action="{{route('notes.store')}}" enctype="multipart/form-data" class=" c form2">
        @csrf
    ...
    <tbody>
        ...
        <td>
           <input type="text"  name="data[{{ $index }}][cc]" min="0" max="20" title="de 0 à 20" >   
    </td>
        <td> <input type="text"  name="data[{{ $index }}][dvr]" min="0" max="2O"  title="de 0 à 20" ></td>
        <td><input type="text"  name="data[{{ $index }}][exm]" min="0" max="20"  title="de 0 à 20"></td>
